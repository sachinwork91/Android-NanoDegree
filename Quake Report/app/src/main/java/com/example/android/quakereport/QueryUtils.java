...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            JSONArray earthquakeFeatures= rootObject.getJSONArray("features");

            for( int i=0; i<earthquakeFeatures.length()   ; i++ ){



                JSONObject feature=  earthquakeFeatures.getJSONObject(i);
